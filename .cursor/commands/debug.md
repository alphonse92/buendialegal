...
- Call: `Skill(bug-diagnosis)` for hypothesis formation
...
- Call: `Skill(bug-diagnosis)` for evidence gathering
...
- Call: `Skill(bug-diagnosis)` for fix proposal
