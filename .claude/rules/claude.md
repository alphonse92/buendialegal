...
Some commands can target to a specific skill. For example, the command `Skill(git-workflow)` will target the `git-workflow` skill in the folder ./.claude/skills/git-workflow/SKILL.md.
...
- **`/start:brainstorm` → Command**: `./.claude/commands/brainstorm.md`
...
- **`/start:constitution` → Command**: `./.claude/commands/constitution.md`
...
- **`/start:validate` → Command**: `./.claude/commands/validate.md`
...
- **`/start:specify` → Command**: `./.claude/commands/specify.md`
...
- **`/start:implement` → Command**: `./.claude/commands/implement.md`
...
- **`/start:review` → Command**: `./.claude/commands/review.md`
...
- **`/start:analyze` → Command**: `./.claude/commands/analyze.md`
...
- **`/start:memory` → Command**: `./.claude/commands/memory.md`
...
- **`Skill(constitution-validation)` → Skill**: `./.claude/skills/constitution-validation/SKILL.md`
...
- **`Skill(drift-detection)` → Skill**: `./.claude/skills/drift-detection/SKILL.md`
...
- **`Skill(specification-validation)` → Skill**: `./.claude/skills/specification-validation/SKILL.md`
  - **Called by commands**: `/start:validate` (core validation methodology).

- **`Skill(specification-management)` → Skill**: `./.claude/skills/specification-management/SKILL.md`
  - **Called by commands**: `/start:specify` (spec lifecycle), `/start:implement` (PLAN reading and phase loading).

- **`Skill(requirements-analysis)` → Skill**: `./.claude/skills/requirements-analysis/SKILL.md`
  - **Called by commands**: `/start:specify` (PRD phase).

- **`Skill(architecture-design)` → Skill**: `./.claude/skills/architecture-design/SKILL.md`
  - **Called by commands**: `/start:specify` (SDD phase).

- **`Skill(implementation-planning)` → Skill**: `./.claude/skills/implementation-planning/SKILL.md`
  - **Called by commands**: `/start:specify` (PLAN phase).

- **`Skill(implementation-verification)` → Skill**: `./.claude/skills/implementation-verification/SKILL.md`
  - **Called by commands**: `/start:implement` (completion checks).

- **`Skill(codebase-analysis)` → Skill**: `./.claude/skills/codebase-analysis/SKILL.md`
  - **Called by commands**: `/start:analyze` (scope initialization).

- **`Skill(safe-refactoring)` → Skill**: `./.claude/skills/safe-refactoring/SKILL.md`
  - **Called by commands**: `/start:refactor`, `/start:simplify` (baseline and methodology).

- **`Skill(brainstorming)` → Skill**: `./.claude/skills/brainstorming/SKILL.md`
...
- **`Skill(bug-diagnosis)` → Skill**: `./.claude/skills/bug-diagnosis/SKILL.md`
  - **Called by commands**: `/start:debug` (all phases of debugging).

- **`Skill(technical-writing)` → Skill**: `./.claude/skills/technical-writing/SKILL.md`
  - **Called by commands**: `/start:document` (documentation methodology).

- **`Skill(git-workflow)` → Skill**: `./.claude/skills/git-workflow/SKILL.md`
  - **Called by commands**: `/start:specify`, `/start:implement` (optional git/PR flows).

- **`Skill(agent-coordination)` → Skill**: `./.claude/skills/agent-coordination/SKILL.md`
...
- **`Skill(agent-debug)` → Skill**: `./.claude/skills/agent-debug/SKILL.md`
...
- **`Skill(api-contract-design)` → Skill**: `./.claude/skills/api-contract-design/SKILL.md`
...
- **`Skill(architecture-selection)` → Skill**: `./.claude/skills/architecture-selection/SKILL.md`
...
- **`Skill(code-quality-review)` → Skill**: `./.claude/skills/code-quality-review/SKILL.md`
...
- **`Skill(code-review)` → Skill**: `./.claude/skills/code-review/SKILL.md`
...
- **`Skill(codebase-navigation)` → Skill**: `./.claude/skills/codebase-navigation/SKILL.md`
...
- **`Skill(coding-conventions)` → Skill**: `./.claude/skills/coding-conventions/SKILL.md`
...
- **`Skill(data-modeling)` → Skill**: `./.claude/skills/data-modeling/SKILL.md`
...
- **`Skill(deployment-pipeline-design)` → Skill**: `./.claude/skills/deployment-pipeline-design/SKILL.md`
...
- **`Skill(documentation-extraction)` → Skill**: `./.claude/skills/documentation-extraction/SKILL.md`
...
- **`Skill(domain-driven-design)` → Skill**: `./.claude/skills/domain-driven-design/SKILL.md`
...
- **`Skill(feature-prioritization)` → Skill**: `./.claude/skills/feature-prioritization/SKILL.md`
...
- **`Skill(knowledge-capture)` → Skill**: `./.claude/skills/knowledge-capture/SKILL.md`
...
- **`Skill(lsp-swift)` → Skill**: `./.claude/skills/lsp-swift/SKILL.md`
...
- **`Skill(lsp-typescript)` → Skill**: `./.claude/skills/lsp-typescript/SKILL.md`
...
- **`Skill(agent-memory)` → Skill**: `./.claude/skills/agent-memory/SKILL.md`
...
- **`Skill(observability-design)` → Skill**: `./.claude/skills/observability-design/SKILL.md`
...
- **`Skill(pattern-detection)` → Skill**: `./.claude/skills/pattern-detection/SKILL.md`
...
- **`Skill(performance-analysis)` → Skill**: `./.claude/skills/performance-analysis/SKILL.md`
...
- **`Skill(requirements-elicitation)` → Skill**: `./.claude/skills/requirements-elicitation/SKILL.md`
...
- **`Skill(security-assessment)` → Skill**: `./.claude/skills/security-assessment/SKILL.md`
...
- **`Skill(swift-concurrency)` → Skill**: `./.claude/skills/swift-concurrency/SKILL.md`
...
- **`Skill(swiftui-expert-skill)` → Skill**: `./.claude/skills/swiftui-expert-skill/SKILL.md`
...
- **`Skill(swiftui-pro)` → Skill**: `./.claude/skills/swiftui-pro/SKILL.md`
...
- **`Skill(task-delegation)` → Skill**: `./.claude/skills/task-delegation/SKILL.md`
...
- **`Skill(tech-stack-detection)` → Skill**: `./.claude/skills/tech-stack-detection/SKILL.md`
...
- **`Skill(testing)` → Skill**: `./.claude/skills/testing/SKILL.md`
...
- **`Skill(tutorial-engineer)` → Skill**: `./.claude/skills/tutorial-engineer/SKILL.md`
...
- **`Skill(user-insight-synthesis)` → Skill**: `./.claude/skills/user-insight-synthesis/SKILL.md`
...
- **`Skill(user-research)` → Skill**: `./.claude/skills/user-research/SKILL.md`
...
- **`Skill(ux-dls)` → Skill**: `./.claude/skills/ux-dls/SKILL.md`
...
- **`Skill(writing-skills)` → Skill**: `./.claude/skills/writing-skills/SKILL.md`
...
- **`Skill(ceo-advisor)` → Skill**: `./.claude/skills/ceo-advisor/SKILL.md`
...
- **`Skill(cfo-advisor)` → Skill**: `./.claude/skills/cfo-advisor/SKILL.md`
...
- **`Skill(cmo-advisor)` → Skill**: `./.claude/skills/cmo-advisor/SKILL.md`
...
- **`Skill(coo-advisor)` → Skill**: `./.claude/skills/coo-advisor/SKILL.md`
...
- **`Skill(cto-advisor)` → Skill**: `./.claude/skills/cto-advisor/SKILL.md`
...
- **`Skill(mvp-architect)` → Skill**: `./.claude/skills/mvp-architect/SKILL.md`
...
- **`Skill(product-design)` → Skill**: `./.claude/skills/product-design/SKILL.md`
  - **Purpose**: Expert product design covering UI/UX design, design systems, prototyping, user research, and design thinking.
  - **Called by commands**: Standalone skill.

- **`Skill(product-management)` → Skill**: `./.claude/skills/product-management/SKILL.md`
...
- **`Skill(product-strategy)` → Skill**: `./.claude/skills/product-strategy/SKILL.md`
...
- **`Skill(revenuecat)` → Skill**: `./.claude/skills/revenuecat/SKILL.md`
...
- **`Skill(solution-architecture)` → Skill**: `./.claude/skills/solution-architecture/SKILL.md`
...
- **`Skill(complexity-mitigator)` → Skill**: `./.claude/skills/complexity-mitigator/SKILL.md`
...
- **`Skill(ticket-triage)` → Skill**: `./.claude/skills/ticket-triage/SKILL.md`
...
- **`Skill(ios-developer)` → Skill**: `./.claude/skills/ios-developer/SKILL.md`
...
- **`Skill(prove-it)` → Skill**: `./.claude/skills/prove-it/SKILL.md`
...
- **`Skill(apple-hig-designer)` → Skill**: `./.claude/skills/apple-hig-designer/SKILL.md`
...
- **`Skill(mobile-ios-design)` → Skill**: `./.claude/skills/mobile-ios-design/SKILL.md`
...
- **`Skill(ios-localization)` → Skill**: `./.claude/skills/ios-localization/SKILL.md`
...
- **`Skill(xlsx)` → Skill**: `./.claude/skills/xlsx/SKILL.md`
...
- **General-purpose orchestration agents**
  - **`the-chief` → Agent**: `./.claude/agents/the-chief.md`
  - **`the-meta-agent` → Agent**: `./.claude/agents/the-meta-agent.md`

- **Build/implementation agents**
  - **`build-feature` → Agent**: `./.claude/agents/build-feature.md`
  - **`build-containers` → Agent**: `./.claude/agents/build-containers.md`
  - **`build-infrastructure` → Agent**: `./.claude/agents/build-infrastructure.md`
  - **`build-pipelines` → Agent**: `./.claude/agents/build-pipelines.md`

- **iOS specialist**
  - **`ios-expert` → Agent**: `./.claude/agents/ios-expert.md`

- **Design agents**
  - **`design-system` → Agent**: `./.claude/agents/design-system.md`
  - **`design-interaction` → Agent**: `./.claude/agents/design-interaction.md`
  - **`design-visual` → Agent**: `./.claude/agents/design-visual.md`

- **Research agents**
  - **`research-market` → Agent**: `./.claude/agents/research-market.md`
  - **`research-requirements` → Agent**: `./.claude/agents/research-requirements.md`
  - **`research-user` → Agent**: `./.claude/agents/research-user.md`

- **Testing agents**
  - **`test-quality` → Agent**: `./.claude/agents/test-quality.md`
  - **`test-performance` → Agent**: `./.claude/agents/test-performance.md`

- **Review agents**
  - **`review-security` → Agent**: `./.claude/agents/review-security.md`
  - **`review-complexity` → Agent**: `./.claude/agents/review-complexity.md`
  - **`review-concurrency` → Agent**: `./.claude/agents/review-concurrency.md`
  - **`review-dependency` → Agent**: `./.claude/agents/review-dependency.md`
  - **`review-compatibility` → Agent**: `./.claude/agents/review-compatibility.md`

- **Operational agents**
  - **`monitor-production` → Agent**: `./.claude/agents/monitor-production.md`
  - **`optimize-performance` → Agent**: `./.claude/agents/optimize-performance.md`
  - **`build-accessibility` → Agent**: `./.claude/agents/build-accessibility.md`

- **Utility agents**
  - **`exploratory-rule-writter` → Agent**: `./.claude/agents/exploratory-rule-writter.md`
