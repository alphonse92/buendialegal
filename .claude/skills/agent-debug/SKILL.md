...
- Describe:
  - That you would use `Read` on `.claude/commands/specify.md` and relevant skills (`specification-management`, `requirements-analysis`, `architecture-design`, `implementation-planning`).
