...
./skills/specification-management/spec.py "feature-name"

# Read existing spec metadata (TOML output)
./skills/specification-management/spec.py 004 --read

# Add template to existing spec
./skills/specification-management/spec.py 004 --add product-requirements
```
