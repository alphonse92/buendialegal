...
- Describe:
  - That you would use `Read` on `.agents/commands/specify.md` and relevant skills (`specification-management`, `requirements-analysis`, `architecture-design`, `implementation-planning`).
